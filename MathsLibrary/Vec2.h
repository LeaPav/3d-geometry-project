...
namespace math{
    ...
    public:
        ...
        T& operator[](int index);// { if (index == 0) return x; else if (index == 1) return y; else throw std::out_of_range("Vec2 index out of range"); }
        ...
        //{ // t : facteur d'interpolation, entre 0-1
